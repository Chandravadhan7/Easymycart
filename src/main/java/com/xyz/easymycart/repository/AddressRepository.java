...
public interface AddressRepository extends JpaRepository<Address,Long> {
    ...
    @Modifying
    @Transactional
    @Query(value = "UPDATE address SET full_name = :fullName, phone = :phone, pin_code = :pinCode, flat_number = :flatNumber, Area = :area, village = :village, landmark = :landmark, district = :district, state = :state WHERE id = :id", nativeQuery = true)
